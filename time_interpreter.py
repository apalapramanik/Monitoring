...
class DiscreteTimeInterpreter(TimeInterpreter):
    ...
    def dataset_check(self, dataset):
        ...
        if not dataset['time']:
            ...
            raise MonException('evaluate: The input does not contain the time field')
        return
    ...
    def time_unit_transformer(self, node):
        ...
        if b.numerator % b.denominator > 0:
            raise MonException('The operator bound must be a multiple of the sampling period')
